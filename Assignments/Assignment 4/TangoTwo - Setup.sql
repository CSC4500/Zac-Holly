...
CREATE TABLE `tangotwo`.`DOTA_TEAM` (
    ...
    DOTA_TEAM_REGION        VARCHAR(100)    NOT NULL,
...
CREATE TABLE `tangotwo`.`DOTA_PLAYER` (
    ...
    DOTA_PLAYER_COUNTRY     VARCHAR(100)    NOT NULL,
...
CREATE TABLE `tangotwo`.`DOTA_TOP_HERO` (
    ...
    TOP_HERO_WIN_RATE       DECIMAL(5,4)    AS (TOP_HERO_MATCHES_WON / TOP_HERO_MATCHES_PLAYED),
